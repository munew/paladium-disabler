...
#define null NULL
    ...
    /**
     * Selects text between two indices.  Selection dependencies the text at the start index
    ...
    /**
     * Get text attributes between two indices.  The attribute list dependencies the text at the
